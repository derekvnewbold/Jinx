...
public class OfferController {
	...
	static {
    	...
    	content = new Content();
    	content.setId(4);
    	content.setTvURL("/img/utes_trivia/tv/Trivia Layout.png");
    	content.setMobileURL("/img/utes_trivia/mobile/mobile.html?v=2");
    	offer.setContent(content);
    	offerList.add(offer);
    	...
    	content.setMobileURL("/img/realestate/mobile.html");
    	offer.setContent(content);
    	offerList.add(offer);
	}
